...
export const isJsonContentType = ( headers:Headers ) => 
  ['application/vnd.api+json', 
    ...
    'application/pdf', 
    'multipart/form-data'].includes(headers.get('content-type')?.trimEnd()!);
...
export const processError = (error: { status: number; data: IResponse<void> }, meta: any, arg: unknown): { status: number; data: IResponse<void>; } => {
